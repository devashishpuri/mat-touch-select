...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MatTouchSelectComponent", function() { return MatTouchSelectComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MatTouchSelectModule", function() { return MatTouchSelectModule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ɵa", function() { return MatTouchOptionsComponent; });
...
if (false) {}
class MatTouchOptionsComponent {
    /**
     * @param {?} dialogRef
     * @param {?} data
     */
...
/** @nocollapse */
MatTouchOptionsComponent.ctorParameters = () => [
...
class MatTouchSelectComponent {
     ...
     */
    constructor(ngControl, dialog, overlayContainer) {
    ...
    get errorState() {
        if (this.errorStateMatcher) {
            return this.errorStateMatcher.isErrorState((/** @type {?} */ (this.ngControl.control)), null);
        }
        else {
    ...
    onContainerClick(event) {
        ...
        if (((/** @type {?} */ (event.target))).classList.contains('mat-form-field-infix') ||
            ((/** @type {?} */ (event.target))).classList.contains('mat-form-field-flex')) {
            if (this.touchUi) {
...
MatTouchSelectComponent.decorators = [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"], args: [{
                ...
                providers: [{ provide: _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatFormFieldControl"], useExisting: MatTouchSelectComponent }]
            }] }
];
/** @nocollapse */
MatTouchSelectComponent.ctorParameters = () => [
...
MatTouchSelectComponent.propDecorators = {
    select: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['select', { static: false },] }],
...
/* harmony import */ var mat_touch_select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! mat-touch-select */ "../../dist/mat-touch-select/fesm2015/mat-touch-select.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            mat_touch_select__WEBPACK_IMPORTED_MODULE_5__["MatTouchSelectModule"],
...
module.exports = __webpack_require__(/*! /Users/devashishpuri/Documents/Projects/Angular/libs/mat-touch-select/projects/demo/src/main.ts */"./src/main.ts");
